...
class ExtratorURL:
    ...
    def get_valor_parametro(self, nome_parametro):
        ...
        valor = self.get_url_parametros()[indice_valor:] if indice_e_comercial == - \
            1 else self.get_url_parametros()[indice_valor:indice_e_comercial]
        return valor


extrator_url = ExtratorURL(
    "https://bytebank.com/cambio?moedaDestino=dolar&moedaOrigem=real&quantidade=100")
