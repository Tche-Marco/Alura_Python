...
# conta_corrente1 = ContaCorrente(None, 400, 1234)
# conta_corrente2 = ContaCorrente(None, 401, 1235)
# try:
#     conta_corrente1.sacar(1000)
#     print('CC1 Saldo: ', conta_corrente1.saldo)
#     print('CC2 Saldo: ', conta_corrente2.saldo)
